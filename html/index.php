...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="Michael,Palmer,portfolio,computer science,developer,photographer,student">
                 ...
                 <div class="container">
                    <div class="row">
                        <div class="col-md-12 home-inner">
                            <img src="img/personal.jpg" height="192px" alt="personal image"
                                 class="wow animated fadeInUp" data-wow-delay="0.3s">
                                <h1 class="intro-text wow animated fadeInUp " data-wow-delay="0.6s">
                                    Hello, I am Michael
                                </h1>
                            <p class="lead wow animated bounceIn" data-wow-delay="0.9s">
                                Developer, Photographer, Student
                            </p>
                            <p class="wow fadeInLeft" data-wow-delay="1.0s">
                                <a href="#about" class="btn btn-lg btn-border-color">More about me</a>
                                <a href="#contact" class="btn btn-lg btn-border-default">Contact me</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="about-img col-md-12">
                        <img src="img/personal-rha.jpg" alt=""
                             class="wow animated rotateInDownLeft" data-wow-delay="0.6s">
                    </div>
                </div>
                <div class="row intro-row">
                    <div class="col-md-12 about-me text-center">
                        <h1>Hello</h1>
                        <h2>I am Michael Palmer, a <span>Software/Web Developer</span> and
                            <span>Photographer</span> from the USA</h2>
                        <p>
                            I am a passionate Computer Science student with a desire to work in a software engineering
                            role that will provide me with the opportunity to contribute to projects that will have a
                            lasting impact to the business. I have gained project management experience through my
                            first internship with BMW Manufacturing. During my second internship with the company,
                            I have been playing a key role in the development of a pilot project using SAP MII. In my
                            spare time, I enjoy building on my development experience by testing out the features of
                            various programming languages on my personal website.
                        </p><br>
                        <?php /*
            ...
            <div class="about-section-2 parallax" data-stellar-background-ratio="0.5">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="#contact" class="wow animated bounceIn btn btn-theme-color btn-lg"
                               data-wow-delay="0.6s">Let's talk</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="services wow animated fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p>Experience developing ABAP, SAP MII, and E-Recruiting applications on SAP in a
                     ...
                     <div class="col-md-4">
                        <div class="services wow animated fadeInUp" data-wow-delay="0.6s">
                            ...
                            <p>Experience with multiple programming languages; implemented HTML, CSS, JavaScript, PHP,
                                and MySQL on websites in a Linux environment</p>
                        </div>
                    </div>
                     <div class="col-md-4">
                        <div class="services wow animated fadeInUp" data-wow-delay="0.9s">
                            ...
                            <p>Experience using Digital SLR cameras for event and sports photography, with pictures
                                used on websites, yearbooks, newspapers, and brochures; experience using Adobe
                                Photoshop CS6 and GIMP to produce high quality pictures</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        if (isset($_POST['submit'])) {
                            if ($_POST['name'] != "" && $_POST['email'] != "" &&
                                ...
                                if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                    echo '<h5 style="color:red;text-align:center">' .
                                        'Improperly formatted e-mail address.</h5>';
                                ...
                                if (!$object->verify_status && !$object->limit_status) {
                                    echo '<h5 style="color:red;text-align:center">' .
                                        'E-mail address does not exist or cannot be verified.</h5>';
                                    $eml_validate = "validate";
                                    goto endcontactform;
                                }
                                ...
                                if (!$resp->is_valid) {
                                    echo "<h5 style='color:red;text-align:center'>" .
                                        "The reCAPTCHA wasn't entered correctly.</h5>";
                                    goto endcontactform;
                                }
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="name" id="name"
                                        class="form-control <?php echo $nam_validate ?>"
                                        value="<?php
                                ...
                                <div class="col-md-6">
                                    <input type="email" name="email" class="form-control <?php echo $eml_validate ?>"
                                        value="<?php
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="subject" class="form-control <?php echo $sub_validate ?>"
                                        value="<?php
                                ...
                                <div class="col-md-6">
                                    <input type="url" name="site" class="form-control <?php echo $url_validate ?>"
                                        value="<?php
                                ...
                                <div class="col-md-12">
                                    <textarea name="msg" class="form-control <?php echo $msg_validate ?>" rows="8"
                                ...
                                <div class="col-md-12 text-right">
                                    <button type="submit" name="submit" value="submit"
                                        class="btn btn-lg btn-theme-color wow animated fadeInLeft"
                                        data-wow-delay="0.6s">Send Message</button>
                                </div>
                            </div>
                        </form>
                     </div>
                    ...
                    <div class="col-md-12 wow animated bounceIn">
                     ...
                     <div class="col-md-12 text-center">
                         <ul class="social-big list-inline">
                             <li><a href="https://www.linkedin.com/in/michaeldpalmer" target="_blank">
                                     <i class="ion-social-linkedin-outline lkin" data-toggle="tooltip"
                                        title="" data-original-title="LinkedIn" data-placement="top"></i></a></li>
                             <li><a href="http://git.michaeldpalmer.com" target="_blank">
                                     <i class="ion-social-github-outline git" data-toggle="tooltip"
                                        title="" data-original-title="GitLab" data-placement="top"></i></a></li>
                             <li><a href="https://www.hackerrank.com/MichaelPalmer" target="_blank">
                                     <i class="ion-social-hackerrank hackerrank" data-toggle="tooltip" title=""
                                        data-original-title="HackerRank" data-placement="top"></i></a></li>
                         </ul>
                     </div>
                </div>
            </div>
